...
use OtomaticAi\Vendors\Doctrine\DBAL\Connection as DoctrineConnection;
use OtomaticAi\Vendors\Doctrine\DBAL\Types\Type;
use Exception;
use OtomaticAi\Vendors\Illuminate\Contracts\Events\Dispatcher;
use OtomaticAi\Vendors\Illuminate\Database\Events\QueryExecuted;
use OtomaticAi\Vendors\Illuminate\Database\Events\StatementPrepared;
use OtomaticAi\Vendors\Illuminate\Database\Events\TransactionBeginning;
use OtomaticAi\Vendors\Illuminate\Database\Events\TransactionCommitted;
use OtomaticAi\Vendors\Illuminate\Database\Events\TransactionRolledBack;
use OtomaticAi\Vendors\Illuminate\Database\Query\Builder as QueryBuilder;
use OtomaticAi\Vendors\Illuminate\Database\Query\Expression;
use OtomaticAi\Vendors\Illuminate\Database\Query\Grammars\Grammar as QueryGrammar;
use OtomaticAi\Vendors\Illuminate\Database\Query\Processors\Processor;
use OtomaticAi\Vendors\Illuminate\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
    ...
    {
        return \class_exists('OtomaticAi\\Vendors\\Doctrine\\DBAL\\Connection');
    }
    /**
