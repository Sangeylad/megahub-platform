...
use OtomaticAi\Vendors\Illuminate\Support\Traits\Tappable;
...
class Stringable implements JsonSerializable
{
    ...
    {
        return new static(\OtomaticAi\Vendors\class_basename($this->value));
    }
    /**
    ...
    {
        return \OtomaticAi\Vendors\collect(\explode($delimiter, $this->value, $limit));
    }
    /**
    ...
    public function split($pattern, $limit = -1, $flags = 0)
    {
        if (\filter_var($pattern, \FILTER_VALIDATE_INT) !== \false) {
            return \OtomaticAi\Vendors\collect(\mb_str_split($this->value, $pattern));
        }
        $segments = \preg_split($pattern, $this->value, $limit, $flags);
        return !empty($segments) ? \OtomaticAi\Vendors\collect($segments) : \OtomaticAi\Vendors\collect();
    }
    /**
    ...
    {
        return \OtomaticAi\Vendors\collect(\sscanf($this->value, $format));
    }
    /**
    ...
    {
        return \OtomaticAi\Vendors\collect(Str::ucsplit($this->value));
    }
    /**
