...
use OtomaticAi\Vendors\GuzzleHttp\BodySummarizer;
use OtomaticAi\Vendors\GuzzleHttp\BodySummarizerInterface;
use OtomaticAi\Vendors\Psr\Http\Client\RequestExceptionInterface;
