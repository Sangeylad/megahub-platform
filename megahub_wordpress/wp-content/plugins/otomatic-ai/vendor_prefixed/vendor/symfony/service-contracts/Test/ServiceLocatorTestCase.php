 ...
 */
namespace OtomaticAi\Vendors\Symfony\Contracts\Service\Test;

use OtomaticAi\Vendors\PHPUnit\Framework\TestCase;
use OtomaticAi\Vendors\Psr\Container\ContainerInterface;
use OtomaticAi\Vendors\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\OtomaticAi\Vendors\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\OtomaticAi\Vendors\Psr\Container\ContainerExceptionInterface::class);
