...
use Closure;
use OtomaticAi\Vendors\Illuminate\Queue\SerializableClosureFactory;
class QueuedClosure
{
    /**
    ...
    public function resolve()
    {
        return function (...$arguments) {
            dispatch(new CallQueuedListener(InvokeQueuedClosure::class, 'handle', ['closure' => SerializableClosureFactory::make($this->closure), 'arguments' => $arguments, 'catch' => \OtomaticAi\Vendors\collect($this->catchCallbacks)->map(function ($callback) {
