...
use OtomaticAi\Vendors\Illuminate\Support\ConfigurationUrlParser;
...
class DatabaseManager implements ConnectionResolverInterface
{
    ...
    {
        if (!\class_exists('OtomaticAi\\Vendors\\Doctrine\\DBAL\\Connection')) {
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return \OtomaticAi\Vendors\tap($callback(), function () use($previousName) {
