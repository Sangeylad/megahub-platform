...
trait AsPivot
{
    ...
    public function delete()
    {
        ...
        $this->touchOwners();
        return \OtomaticAi\Vendors\tap($this->getDeleteQuery()->delete(), function () {
            $this->exists = \false;
    ...
    {
        if (!isset($this->table)) {
            $this->setTable(\str_replace('\\', '', Str::snake(Str::singular(\OtomaticAi\Vendors\class_basename($this)))));
        }
        return $this->table;
    }
    /**
