...
use OtomaticAi\Vendors\Illuminate\Database\MultipleRecordsFoundException;
use OtomaticAi\Vendors\Illuminate\Database\RecordsNotFoundException;
use OtomaticAi\Vendors\Illuminate\Pagination\Cursor;
use OtomaticAi\Vendors\Illuminate\Pagination\CursorPaginator;
use OtomaticAi\Vendors\Illuminate\Pagination\LengthAwarePaginator;
    ...
    protected function paginateUsingCursor($perPage, $columns = ['*'], $cursorName = 'cursor', $cursor = null)
    {
        ...
        if (!\is_null($cursor)) {
            $addCursorConditions = function (self $builder, $previousColumn, $i) use(&$addCursorConditions, $cursor, $orders) {
                $unionBuilders = isset($builder->unions) ? \OtomaticAi\Vendors\collect($builder->unions)->pluck('query') : \OtomaticAi\Vendors\collect();
