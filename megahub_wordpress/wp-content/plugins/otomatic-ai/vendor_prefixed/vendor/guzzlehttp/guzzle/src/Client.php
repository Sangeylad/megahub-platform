...
use OtomaticAi\Vendors\GuzzleHttp\Cookie\CookieJar;
use OtomaticAi\Vendors\GuzzleHttp\Exception\GuzzleException;
use OtomaticAi\Vendors\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \OtomaticAi\Vendors\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
