...
use OtomaticAi\Vendors\Symfony\Component\Console\Application;
use OtomaticAi\Vendors\Symfony\Component\Console\Attribute\AsCommand;
...
class Command
{
    ...
    public function run(InputInterface $input, OutputInterface $output)
    {
        ...
        if (null !== $this->processTitle) {
            ...
            } elseif (\function_exists('OtomaticAi\\Vendors\\setproctitle')) {
                \OtomaticAi\Vendors\setproctitle($this->processTitle);
