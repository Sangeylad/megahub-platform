...
use OtomaticAi\Vendors\Illuminate\Contracts\Support\MessageBag as MessageBagContract;
use OtomaticAi\Vendors\Illuminate\Contracts\Support\MessageProvider;
...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider
{
    ...
    {
        return \OtomaticAi\Vendors\collect($this->messages)->filter(function ($messages, $messageKey) use($key) {
    ...
    {
        return \OtomaticAi\Vendors\collect((array) $messages)->map(function ($message) use($format, $messageKey) {
