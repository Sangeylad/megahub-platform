...
use OtomaticAi\Vendors\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use OtomaticAi\Vendors\Symfony\Component\HttpFoundation\Exception\JsonException;
use OtomaticAi\Vendors\Symfony\Component\HttpFoundation\Exception\SessionNotFoundException;
use OtomaticAi\Vendors\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use OtomaticAi\Vendors\Symfony\Component\HttpFoundation\Session\SessionInterface;
...
class Request
{
    ...
    public static function setTrustedProxies(array $proxies, int $trustedHeaderSet)
    {
        if (self::HEADER_X_FORWARDED_ALL === $trustedHeaderSet) {
            \OtomaticAi\Vendors\trigger_deprecation('symfony/http-foundation', '5.2', 'The "HEADER_X_FORWARDED_ALL" constant is deprecated, use either "HEADER_X_FORWARDED_FOR | HEADER_X_FORWARDED_HOST | HEADER_X_FORWARDED_PORT | HEADER_X_FORWARDED_PROTO" or "HEADER_X_FORWARDED_AWS_ELB" or "HEADER_X_FORWARDED_TRAEFIK" constants instead.');
        }
