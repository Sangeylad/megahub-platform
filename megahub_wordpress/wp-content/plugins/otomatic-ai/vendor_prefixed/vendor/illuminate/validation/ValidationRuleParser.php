...
class ValidationRuleParser
{
    ...
    {
        $merge = \OtomaticAi\Vendors\head($this->explodeRules([$rules]));
    ...
    {
        return \OtomaticAi\Vendors\collect($rules)->mapWithKeys(function ($attributeRules, $attribute) use($data) {
            ...
            return [$attribute => \OtomaticAi\Vendors\collect($attributeRules)->map(function ($rule) use($data) {
