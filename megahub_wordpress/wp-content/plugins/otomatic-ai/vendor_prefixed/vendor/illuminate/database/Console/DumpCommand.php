...
use OtomaticAi\Vendors\Illuminate\Database\ConnectionResolverInterface;
use OtomaticAi\Vendors\Illuminate\Database\Events\SchemaDumped;
use OtomaticAi\Vendors\Illuminate\Filesystem\Filesystem;
use OtomaticAi\Vendors\Illuminate\Support\Facades\Config;
class DumpCommand extends Command
{
    ...
    {
        return \OtomaticAi\Vendors\tap($this->option('path') ?: database_path('schema/' . $connection->getName() . '-schema.dump'), function ($path) {
