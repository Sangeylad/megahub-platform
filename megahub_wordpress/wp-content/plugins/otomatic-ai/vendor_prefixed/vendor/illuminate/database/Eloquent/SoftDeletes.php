...
trait SoftDeletes
{
    ...
    public function forceDelete()
    {
        ...
        return \OtomaticAi\Vendors\tap($this->delete(), function ($deleted) {
    ...
    protected function performDeleteOnModel()
    {
        if ($this->forceDeleting) {
            return \OtomaticAi\Vendors\tap($this->setKeysForSaveQuery($this->newModelQuery())->forceDelete(), function () {
                $this->exists = \false;
            });
        }
