...
use OtomaticAi\Vendors\Illuminate\Contracts\Validation\ImplicitRule;
use OtomaticAi\Vendors\Illuminate\Contracts\Validation\Rule as RuleContract;
use OtomaticAi\Vendors\Illuminate\Contracts\Validation\Validator as ValidatorContract;
...
use OtomaticAi\Vendors\Illuminate\Support\MessageBag;
use OtomaticAi\Vendors\Illuminate\Support\Str;
use OtomaticAi\Vendors\Illuminate\Support\ValidatedInput;
...
class Validator implements ValidatorContract
{
    ...
    {
        \OtomaticAi\Vendors\throw_if($this->fails(), $this->exception, $this);
    ...
    {
        \OtomaticAi\Vendors\throw_if($this->invalid(), $this->exception, $this);
        $results = [];
        ...
        foreach ($this->getRules() as $key => $rules) {
            ...
            $value = \OtomaticAi\Vendors\data_get($this->getData(), $key, $missingValue);
    ...
    {
        return \OtomaticAi\Vendors\collect($this->messages()->toArray())->map(function ($message, $key) {
    ...
    {
        $rules = \OtomaticAi\Vendors\collect($rules)->mapWithKeys(function ($value, $key) {
    ...
    private function dataForSometimesIteration(string $attribute, $removeLastSegmentOfAttribute)
    {
        ...
        return \is_array($data = \OtomaticAi\Vendors\data_get($this->data, $attribute)) ? new Fluent($data) : $data;
    }
    /**
