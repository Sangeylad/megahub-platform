...
use Closure;
use OtomaticAi\Vendors\Mockery;
use OtomaticAi\Vendors\Mockery\LegacyMockInterface;
...
abstract class Facade
{
    ...
    public static function spy()
    {
        if (!static::isMock()) {
            ...
            return \OtomaticAi\Vendors\tap($class ? Mockery::spy($class) : Mockery::spy(), function ($spy) {
                static::swap($spy);
            });
        }
    }
    ...
    {
        return \OtomaticAi\Vendors\tap(static::createMock(), function ($mock) {
            static::swap($mock);
