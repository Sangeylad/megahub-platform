...
use OtomaticAi\Vendors\Predis\Response\ErrorInterface;
...
class RedisSessionHandler extends AbstractSessionHandler
{
    ...
    {
        if (!$redis instanceof \Redis && !$redis instanceof \RedisArray && !$redis instanceof \RedisCluster && !$redis instanceof \OtomaticAi\Vendors\Predis\ClientInterface && !$redis instanceof RedisProxy && !$redis instanceof RedisClusterProxy) {
