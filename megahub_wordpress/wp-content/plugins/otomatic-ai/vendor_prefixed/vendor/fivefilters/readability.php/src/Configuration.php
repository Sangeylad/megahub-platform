...
use OtomaticAi\Vendors\Psr\Log\LoggerAwareTrait;
use OtomaticAi\Vendors\Psr\Log\LoggerInterface;
use OtomaticAi\Vendors\Psr\Log\NullLogger;
/**
 * Class Configuration.
 */
class Configuration
{
     ...
     * @var bool
     */
    protected $stripUnlikelyCandidates = \true;
    /**
     * @var bool
     */
    protected $cleanConditionally = \true;
    /**
     * @var bool
     */
    protected $weightClasses = \true;
    /**
     * @var bool
     */
