# /var/www/megahub/backend/mailing_deliverability_monitoring/urls.py
...
app_name = 'mailing_deliverability_monitoring'
urlpatterns = [
    # TODO: Endpoints REST à implémenter
    # Suivra le même pattern que les apps core :
    # - GET/POST /deliverability_monitoring/ → CRUD principal
