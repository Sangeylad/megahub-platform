...
use OtomaticAi\Vendors\Egulias\EmailValidator\Validation\MessageIDValidation;
use OtomaticAi\Vendors\Egulias\EmailValidator\Validation\RFCValidation;
use OtomaticAi\Vendors\Symfony\Component\Mime\Encoder\IdnAddressEncoder;
...
final class Address
{
    ...
    {
        \OtomaticAi\Vendors\trigger_deprecation('symfony/mime', '5.2', '"%s()" is deprecated, use "%s::create()" instead.', __METHOD__, __CLASS__);
