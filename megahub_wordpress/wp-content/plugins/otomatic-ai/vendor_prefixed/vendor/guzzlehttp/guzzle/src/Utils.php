...
use OtomaticAi\Vendors\GuzzleHttp\Handler\CurlMultiHandler;
use OtomaticAi\Vendors\GuzzleHttp\Handler\Proxy;
use OtomaticAi\Vendors\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \OtomaticAi\Vendors\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
