...
trait InteractsWithPivotTable
{
    ...
    {
        return $this->sync(\OtomaticAi\Vendors\collect($this->parseIds($ids))->mapWithKeys(function ($id) use($values) {
            return [$id => $values];
        }), $detaching);
    }
    /**
    ...
    {
        return \OtomaticAi\Vendors\collect($records)->mapWithKeys(function ($attributes, $id) {
