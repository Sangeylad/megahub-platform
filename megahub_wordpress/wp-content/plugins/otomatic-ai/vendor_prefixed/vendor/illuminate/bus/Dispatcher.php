...
use OtomaticAi\Vendors\Illuminate\Foundation\Bus\PendingChain;
use OtomaticAi\Vendors\Illuminate\Pipeline\Pipeline;
use OtomaticAi\Vendors\Illuminate\Queue\InteractsWithQueue;
use OtomaticAi\Vendors\Illuminate\Queue\Jobs\SyncJob;
...
class Dispatcher implements QueueingDispatcher
{
    ...
    {
        $uses = \OtomaticAi\Vendors\class_uses_recursive($command);
