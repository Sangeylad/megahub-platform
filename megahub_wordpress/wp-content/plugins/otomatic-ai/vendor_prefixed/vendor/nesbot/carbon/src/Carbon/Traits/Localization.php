 ...
 */
namespace OtomaticAi\Vendors\Carbon\Traits;

use OtomaticAi\Vendors\Carbon\CarbonInterface;
use OtomaticAi\Vendors\Carbon\Exceptions\InvalidTypeException;
use OtomaticAi\Vendors\Carbon\Exceptions\NotLocaleAwareException;
use OtomaticAi\Vendors\Carbon\Language;
use OtomaticAi\Vendors\Carbon\Translator;
use OtomaticAi\Vendors\Carbon\TranslatorStrongTypeInterface;
use Closure;
use OtomaticAi\Vendors\Symfony\Component\Translation\TranslatorBagInterface;
use OtomaticAi\Vendors\Symfony\Component\Translation\TranslatorInterface;
use OtomaticAi\Vendors\Symfony\Contracts\Translation\LocaleAwareInterface;
use OtomaticAi\Vendors\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (\interface_exists('OtomaticAi\\Vendors\\Symfony\\Contracts\\Translation\\TranslatorInterface') && !\interface_exists('OtomaticAi\\Vendors\\Symfony\\Component\\Translation\\TranslatorInterface')) {
    \class_alias('OtomaticAi\\Vendors\\Symfony\\Contracts\\Translation\\TranslatorInterface', 'OtomaticAi\\Vendors\\Symfony\\Component\\Translation\\TranslatorInterface');
}
