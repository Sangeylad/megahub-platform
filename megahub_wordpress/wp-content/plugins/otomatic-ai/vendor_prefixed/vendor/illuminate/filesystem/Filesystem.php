...
use OtomaticAi\Vendors\Illuminate\Contracts\Filesystem\FileNotFoundException;
use OtomaticAi\Vendors\Illuminate\Support\LazyCollection;
use OtomaticAi\Vendors\Illuminate\Support\Traits\Macroable;
use RuntimeException;
use SplFileObject;
use OtomaticAi\Vendors\Symfony\Component\Filesystem\Filesystem as SymfonyFilesystem;
...
class Filesystem
{
    ...
    {
        if (!\OtomaticAi\Vendors\windows_os()) {
