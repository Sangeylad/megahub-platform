...
use Closure;
use OtomaticAi\Vendors\Illuminate\Contracts\Queue\Queue;
use OtomaticAi\Vendors\Illuminate\Queue\QueueManager;
...
class QueueFake extends QueueManager implements Queue
{
    ...
    public function pushed($job, $callback = null)
    {
        ...
        return \OtomaticAi\Vendors\collect($this->jobs[$job])->filter(function ($data) use($callback) {
    ...
    {
        return \OtomaticAi\Vendors\collect($this->jobs)->flatten(1)->filter(function ($job) use($queue) {
