...
use OtomaticAi\Vendors\Illuminate\Http\Resources\Json\JsonResource;
...
abstract class AbstractCursorPaginator implements Htmlable
{
    ...
    {
        return \OtomaticAi\Vendors\collect($this->parameters)->flip()->map(function ($_, $parameterName) use($item) {
