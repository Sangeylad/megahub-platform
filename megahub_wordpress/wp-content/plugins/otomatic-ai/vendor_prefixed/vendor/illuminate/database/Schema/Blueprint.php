...
use OtomaticAi\Vendors\Illuminate\Database\Schema\Grammars\Grammar;
use OtomaticAi\Vendors\Illuminate\Database\SQLiteConnection;
...
class Blueprint
{
    ...
    {
        return \OtomaticAi\Vendors\collect($this->commands)->filter(function ($command) use($names) {
    ...
    {
        return \OtomaticAi\Vendors\collect($this->commands)->contains(function ($command) {
    ...
    {
        return !\is_null(\OtomaticAi\Vendors\collect($this->getAddedColumns())->first(function ($column) {
    ...
    public function autoIncrementingStartingValues()
    {
        ...
        return \OtomaticAi\Vendors\collect($this->getAddedColumns())->mapWithKeys(function ($column) {
