 ...
 */
namespace OtomaticAi\Vendors\Composer;

use OtomaticAi\Vendors\Composer\Autoload\ClassLoader;
use OtomaticAi\Vendors\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('OtomaticAi\\Vendors\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
