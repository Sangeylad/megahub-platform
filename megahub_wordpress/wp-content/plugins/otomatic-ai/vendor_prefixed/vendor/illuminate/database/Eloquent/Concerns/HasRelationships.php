...
use Closure;
use OtomaticAi\Vendors\Illuminate\Database\ClassMorphViolationException;
...
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\BelongsTo;
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\BelongsToMany;
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\HasMany;
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\HasOne;
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\HasOneThrough;
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\MorphMany;
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\MorphOne;
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\MorphTo;
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\MorphToMany;
...
trait HasRelationships
{
    ...
    public function joiningTable($related, $instance = null)
    {
        ...
        $segments = [$instance ? $instance->joiningTableSegment() : Str::snake(\OtomaticAi\Vendors\class_basename($related)), $this->joiningTableSegment()];
    ...
    {
        return Str::snake(\OtomaticAi\Vendors\class_basename($this));
    }
    /**
