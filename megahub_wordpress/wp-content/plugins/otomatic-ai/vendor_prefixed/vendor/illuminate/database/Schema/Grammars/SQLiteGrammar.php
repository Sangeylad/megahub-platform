...
use OtomaticAi\Vendors\Doctrine\DBAL\Schema\Index;
...
class SQLiteGrammar extends Grammar
{
    ...
    protected function addForeignKeys(Blueprint $blueprint)
    {
        ...
        return \OtomaticAi\Vendors\collect($foreigns)->reduce(function ($sql, $foreign) {
    ...
    public function compileAdd(Blueprint $blueprint, Fluent $command)
    {
        ...
        return \OtomaticAi\Vendors\collect($columns)->reject(function ($column) {
