...
use OtomaticAi\Vendors\Masterminds\HTML5;
use OtomaticAi\Vendors\Symfony\Component\CssSelector\CssSelectorConverter;
/**
...
class Crawler implements \Countable, \IteratorAggregate
{
    ...
    {
        \OtomaticAi\Vendors\trigger_deprecation('symfony/dom-crawler', '5.3', 'The %s() method is deprecated, use ancestors() instead.', __METHOD__);
