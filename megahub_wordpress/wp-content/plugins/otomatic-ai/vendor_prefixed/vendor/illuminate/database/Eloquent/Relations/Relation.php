...
abstract class Relation
{
    ...
    {
        return \OtomaticAi\Vendors\collect($models)->map(function ($value) use($key) {
    ...
    {
        return $model->getKeyName() === \OtomaticAi\Vendors\last(\explode('.', $key)) && \in_array($model->getKeyType(), ['int', 'integer']) ? 'whereIntegerInRaw' : 'whereIn';
    }
    /**
