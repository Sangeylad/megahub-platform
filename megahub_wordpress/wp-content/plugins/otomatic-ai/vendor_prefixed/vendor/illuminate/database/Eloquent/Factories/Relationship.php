...
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\HasOneOrMany;
use OtomaticAi\Vendors\Illuminate\Database\Eloquent\Relations\MorphOneOrMany;
class Relationship
{
    /**
