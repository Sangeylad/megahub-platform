...
use OtomaticAi\Vendors\Illuminate\Bus\Queueable;
use OtomaticAi\Vendors\Illuminate\Container\Container;
use OtomaticAi\Vendors\Illuminate\Contracts\Queue\Job;
...
class CallQueuedListener implements ShouldQueue
{
    ...
    {
        if (\in_array(InteractsWithQueue::class, \OtomaticAi\Vendors\class_uses_recursive($instance))) {
            $instance->setJob($job);
        }
        return $instance;
    }
