...
class Builder
{
    ...
    {
        $this->build(\OtomaticAi\Vendors\tap($this->createBlueprint($table), function ($blueprint) use($callback) {
            $blueprint->create();
            $callback($blueprint);
        }));
    }
    ...
    {
        $this->build(\OtomaticAi\Vendors\tap($this->createBlueprint($table), function ($blueprint) {
            $blueprint->drop();
        }));
    }
    /**
    ...
    {
        $this->build(\OtomaticAi\Vendors\tap($this->createBlueprint($from), function ($blueprint) use($to) {
            $blueprint->rename($to);
        }));
    }
    /**
