# /var/www/megahub/backend/mailing_deliverability_authentication/urls.py
...
app_name = 'mailing_deliverability_authentication'
urlpatterns = [
    # TODO: Endpoints REST à implémenter
    # Suivra le même pattern que les apps core :
    # - GET/POST /deliverability_authentication/ → CRUD principal
