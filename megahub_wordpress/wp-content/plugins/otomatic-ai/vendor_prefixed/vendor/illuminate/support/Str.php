...
use OtomaticAi\Vendors\League\CommonMark\GithubFlavoredMarkdownConverter;
use OtomaticAi\Vendors\Ramsey\Uuid\Codec\TimestampFirstCombCodec;
use OtomaticAi\Vendors\Ramsey\Uuid\Generator\CombGenerator;
use OtomaticAi\Vendors\Ramsey\Uuid\Uuid;
use OtomaticAi\Vendors\Ramsey\Uuid\UuidFactory;
use OtomaticAi\Vendors\voku\helper\ASCII;
class Str
{
    use Macroable;
    /**
    ...
    public static function matchAll($pattern, $subject)
    {
        ...
        return \OtomaticAi\Vendors\collect($matches[1] ?? $matches[0]);
    }
    /**
