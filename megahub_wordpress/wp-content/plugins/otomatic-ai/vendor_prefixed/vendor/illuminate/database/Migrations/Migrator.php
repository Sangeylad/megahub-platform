...
use OtomaticAi\Vendors\Doctrine\DBAL\Schema\SchemaException;
...
use OtomaticAi\Vendors\Illuminate\Database\Events\MigrationEnded;
use OtomaticAi\Vendors\Illuminate\Database\Events\MigrationsEnded;
use OtomaticAi\Vendors\Illuminate\Database\Events\MigrationsStarted;
use OtomaticAi\Vendors\Illuminate\Database\Events\MigrationStarted;
use OtomaticAi\Vendors\Illuminate\Database\Events\NoPendingMigrations;
...
class Migrator
{
    ...
    protected function resetMigrations(array $migrations, array $paths, $pretend = \false)
    {
        ...
        $migrations = \OtomaticAi\Vendors\collect($migrations)->map(function ($m) {
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return \OtomaticAi\Vendors\tap($callback(), function () use($previousConnection) {
